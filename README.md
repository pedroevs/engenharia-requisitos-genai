...
│   ├── gestao-riscos.md [curso 9]
│   ├── plano-comunicacao.md [curso 9]
└── especificacao/
...
- Gestão de Riscos do Projeto (10 riscos identificados com estratégias de resposta) [curso 9]
- Plano de Comunicação e Gestão de Incidentes [curso 9]
